  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <PageHero
        ...
        title="Gear Exchange"
        description="Listed by local players, for local players across Livingston and nearby NJ towns. Coordinate directly - CourtConnect never touches payment or shipping."
      >
